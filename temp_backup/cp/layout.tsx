...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-white">Dashboard Yükleniyor...</h2>
          <p className="text-purple-200 mt-2">Hesap bilgileriniz kontrol ediliyor</p>
        </motion.div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900 relative">
      ...
      <div className="lg:hidden">
        <motion.div
          initial={{ y: 100 }}
          animate={{ y: 0 }}
          className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-md border-t border-purple-500/20 shadow-lg z-30"
        >
