  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-purple-600 via-purple-700 to-blue-600 rounded-2xl p-8 text-white relative overflow-hidden border border-purple-500/20"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {quickStats.map((stat, index) => {
          ...
          return (
            ...
            >
              <Card className="hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 border-purple-500/20 bg-background/50 backdrop-blur-md">
              ...
              {quickActions.map((action) => {
                ...
                return (
                  <Button
                    key={action.id}
                    variant="ghost"
                    className="w-full justify-start h-auto p-4 group hover:bg-purple-500/10 hover:border-purple-500/20 border border-transparent transition-all duration-300"
                ...
                {recentActivities.map((activity, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center gap-4 p-3 rounded-lg hover:bg-purple-500/10 transition-colors border border-transparent hover:border-purple-500/20"
                    >
                      <div className={cn(
                      ...
                      <div className="text-right">
                        ...
                        <Badge 
                          variant="outline" 
                          className={cn("text-xs mt-1 border-current", getActivityColor(activity.status))}
                        >
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Sipariş Tamamlanma</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Ödeme Başarı Oranı</span>
